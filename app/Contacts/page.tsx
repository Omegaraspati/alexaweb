...
import background from '../../public/images/bannercontacts1.png'
...
const page = () => {
    ...
    return (
        ...
        <div>
            ...
            <div className='pl-72 pt-96'>
            </div>

            {/* ////////////////////////////////////////////////////////////////////////////////////////
             */}
             <div className="container pt-20 my-24 mx-auto md:px-6">
      ...
      <div className="flex flex-wrap items-center">
        <div className="block w-full shrink-0 grow-0 basis-auto lg:flex lg:w-6/12 xl:w-4/12">
          <div className="h-[500px] w-full">
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7921.089181125358!2d107.634581!3d-6.9449!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x596cb206da5c0293!2sAlexa!5e0!3m2!1sen!2sid!4v1659576490898!5m2!1sen!2sid"
            ...
            <div className="mb-12 w-full shrink-0 grow-0 basis-auto px-3 md:w-6/12 md:px-6 lg:w-full xl:w-6/12 xl:px-12">
              <div className="flex items-start">
                ...
                <div className="ml-6 grow">
                  ...
                  TechnicalSupport@alexapurewater.com
                  </p>
                  <p className="text-neutral-500 dark:text-neutral-200">
                    +62 821 5467 3332
                  </p>
            ...
            <div className="w-full shrink-0 grow-0 basis-auto px-3 md:w-6/12 md:px-6 lg:w-full xl:w-6/12 xl:px-12">
              <div className="align-start flex">
                ...
                <div className="ml-6 grow">
                  ...
                  <p className="text-neutral-500 dark:text-neutral-200">
                    webdevelopment@alexapurewater.com
                  </p>
                  <p className="text-neutral-500 dark:text-neutral-200">
                    +62 852 4234 4444
                  </p>
...
<div className="container my-24 mx-auto md:px-6 border-gray-950">
  {/* <!-- Section: Design Block --> */}
